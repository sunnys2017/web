   ...
   <div id ="top">
    ...
    <div id="left">
      ...
      <div class="panel-body">
        <small> 
        <a href="./patient/findDoctors">Find Doctors</a>
        <br><br>
        <a href="./patient/manageProfile">Manage Profile</a>
        <br><br>
        <a href="./patient/reviewInvoice">Review Invoice</a>
        <br><br>
        <a href="./patient/reviewAppointments">Review Appointments</a>
        </small>
      </div>
      </div>
    </div>
    ...
    <div class="panel-heading"><h4>Profile</h4></div>
     <div class="panel-body">
       Welcome, customer: ${patient.firstName}, ${patient.lastName}! Current time is :<div id="txt"></div>  
     <br>
     Today's weather:
