...
<div id = "all">
   ...
   <div id ="top">
    ...
    <br>                                                                 
    <div class="panel panel-info">
     <div class="panel-heading"><h4>Review Invoices</h4></div>
        <div class="panel-body">
          ...
          <div>
		   <c:if  test="${!empty invoiceList}">
			...
			<table id = "tableTry">
				<tr id = "tdTry">
		    		<th align="center"><strong>HospitalAddress</strong></th>
		    		<th align="center">Total Fee</th>
		    		<th align="center">Invoice Date</th>
		    		<th align="center">Status</th>
		    		<th align="center">Note</th>
		    		<th align="center">InvoiceDueDate</th>
