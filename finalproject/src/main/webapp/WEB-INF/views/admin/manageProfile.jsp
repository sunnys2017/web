   ...
   <div id ="top">
    ...
    <div class="panel panel-info">
     <div class="panel-heading"><h4>Update Profile</h4></div>
        ...
        <div>
			<table id = "tableTry">
				<tr id = "tdTry">
		    		...
		    		<tr>
		        		<td id = "tdTry">${admin.firstName},${admin.middleName},${admin.lastName} </td>
        ...
        <br>     
        <form ACTION="../updateAdminProfile/${admin.adminID}" method="POST">
       <div class="input-group input-group-sm"><span class="input-group-addon">First Name   :</span>
       <input type="text" class="form-control" placeholder="${admin.firstName}" name = "firstName"><br>
       <span class="input-group-addon">Middle Name  :</span>
       <input type="text" class="form-control" placeholder="${admin.middleName}" name = "middleName">
       </div><br>
       <div class="input-group input-group-sm"><span class="input-group-addon">Last Name    :</span>
       <input type="text" class="form-control" placeholder="${admin.lastName}" name = "lastName">
       </div><br>
       ...
       <div class="input-group input-group-sm"><span class="input-group-addon">PhoneNumber  :</span>
       <input type="text" class="form-control" placeholder="${admin.phoneNumber}" name = "phoneNumber">
       </div><br>
       <div class="input-group input-group-sm"><span class="input-group-addon">SSN          :</span>
       <input type="text" class="form-control" placeholder="${admin.ssn}" name = "ssn">
       </div><br>
