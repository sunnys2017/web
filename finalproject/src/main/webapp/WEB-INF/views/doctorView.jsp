...
<div id = "all">
   ...
   <div id ="top">
    ...
    <div id="left">
      ...
      <small> 
      <a href="./doctor/manageDoctorAppointments">Manage Appointments</a>
      <br><br>
      <a href="./doctor/manageDoctorProfile">Manage Profile</a>
      </small>
      </div>
      </div>
    </div>
    ...
    <br>
    <div class="panel panel-info">
    <div class="panel-heading"><h4>Doctor WorkArea</h4></div>
     <div class="panel-body">
        welcome, doctor ${doctor.firstName},${doctor.lastName}.  Current time is :<div id="txt"></div>  
     <br>
     Today's weather:
