			...
			<table id = "tableTry">
				...
				<c:forEach items="${appointmentList}" var="appointment">
		    		<tr>
		        		...
		        		<td id = "tdTry"><a href="/finalproject/doctor/updateRecord/${appointment.recordID}"><button type="submit" class="btn btn-default">Update</button></a> </td>
		        		<td id = "tdTry"><a href="/finalproject/doctor/updateAppointment/${appointment.appointmentID}"><button type="submit" class="btn btn-default">Update</button></a></td>
                 </c:forEach>
			  </table>
			  </div>
		  </c:if>
